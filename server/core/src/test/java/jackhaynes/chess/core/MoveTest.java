...
public class MoveTest {
    private class PieceStub extends Piece {
        public PieceStub(PieceColour colour, int x, int y) {
    ...
    public void Given_MoveSamePosition_When_GetType_Should_BeStatic() {
        Move move = new Move(new PieceStub(PieceColour.BLACK, 4, 2), 4, 2);
        assertEquals(MoveType.STATIC, move.getType());
    }

    @Test
    public void Given_MoveHorizontally_When_GetType_Should_BeStraight() {
        Move leftMove = new Move(new PieceStub(PieceColour.BLACK, 4, 5),2, 5);
        Move rightMove = new Move(new PieceStub(PieceColour.BLACK, 4, 5), 5, 5);
    ...
    public void Given_MoveVertically_When_GetType_Should_BeStraight() {
        Move upMove = new Move(new PieceStub(PieceColour.BLACK, 4, 6), 4, 4);
        Move downMove = new Move(new PieceStub(PieceColour.BLACK, 2, 3), 2, 4);
    ...
    public void Given_Move45Degrees_When_GetType_Should_BeValidDiagonal() {
        ...
        // new PieceStub(3, 4)
        Move northEast = new Move(new PieceStub(PieceColour.BLACK, 3, 4), 5, 2);
        Move southEast = new Move(new PieceStub(PieceColour.BLACK, 3, 4), 5, 6);
        Move southWest = new Move(new PieceStub(PieceColour.BLACK, 3, 4), 1, 6);
        Move northWest = new Move(new PieceStub(PieceColour.BLACK, 3, 4), 1, 2);
    ...
    public void Given_MoveNon45Degrees_When_GetType_Should_BeInvalidDiagonal() {
        Move longerHorizontal = new Move(new PieceStub(PieceColour.BLACK, 1, 2), 6, 3);
        Move longerVertical = new Move(new PieceStub(PieceColour.BLACK, 2, 1), 3, 6);
    ...
    public void Given_HorizontalMove_When_GetSteps_Should_ReturnCorrectNumber() {
        Move leftOneMove = new Move(new PieceStub(PieceColour.BLACK, 4, 2), 3, 2);
        Move rightTwoMoves = new Move(new PieceStub(PieceColour.BLACK, 4, 2), 6, 2);
    ...
    public void Given_VerticalMove_When_GetSteps_Should_ReturnCorrectNumber() {
        Move upOneMove = new Move(new PieceStub(PieceColour.BLACK, 2, 5), 2, 4);
        Move downTwoMoves = new Move(new PieceStub(PieceColour.BLACK, 2, 5), 2, 7);
    ...
    public void Given_ValidDiagonalMove_When_GetSteps_Should_ReturnCorrectNumber() {
        Move northEast = new Move(new PieceStub(PieceColour.BLACK, 3, 4), 5, 2);
        Move southEast = new Move(new PieceStub(PieceColour.BLACK, 3, 4), 4, 5);
        Move southWest = new Move(new PieceStub(PieceColour.BLACK, 3, 4), 0, 7);
        Move northWest = new Move(new PieceStub(PieceColour.BLACK, 3, 4), 1, 2);
    ...
    public void Given_BlackPiece_When_MoveVerticallyDown_Should_BeMovingForward() {
        Move move = new Move(new PieceStub(PieceColour.BLACK, 2, 2), 2, 3);
    ...
    public void Given_BlackPiece_When_MoveVerticallyUp_Should_BeMovingBackwards() {
        Move move = new Move(new PieceStub(PieceColour.BLACK, 2, 2), 2, 1);
    ...
    public void Given_WhitePiece_When_MoveVerticallyUp_Should_BeMovingForward() {
        Move move = new Move(new PieceStub(PieceColour.WHITE, 2, 2), 2, 1);
        assertEquals(MoveDirection.FORWARD, move.getDirection());
    }

    @Test
    public void Given_WhitePiece_When_MoveVerticallyDown_Should_BeMovingBackwards() {
        Move move = new Move(new PieceStub(PieceColour.WHITE, 2, 2), 2, 3);
        assertEquals(MoveDirection.BACKWARD, move.getDirection());
    }
}
